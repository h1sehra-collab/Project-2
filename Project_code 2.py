...
with open("class_labels_2.json", "w") as f:
    json.dump(class_labels_2, f)
...
# Step 2.2: Neural Network Architecture Design: Tensorflow
...
#Leaky ReLU is used for complex datasets, but comparison would be valuable.


model = keras.Sequential([
    
    layers.Conv2D(32, (3,3), input_shape = (500, 500, 3)),
    ...
    layers.Flatten(),
    layers.Dense(64),
    layers.LeakyReLU(alpha = 0.1), #Negative Slope
